 ...
 * TODO: Internationalisierung abschlieﬂen
 * TODO: Language-Files checken, ob tatsächlich alle Werte benˆtigt werden
 * TODO: Sonderzeichen werden in den Balloontips unter Windows nicht korrekt angezeigt. Scheint ein Windowsproblem zu sein. Lˆsung/Workaround noch nicht gefunden.
 *
 * JFritz 0.6.1
 * - Neue Strings: 
 *		browse
 ...
 * - Neu: Zeit, bis Popup-Nachrichten ausgeblendet sind, einstellbar gemacht (Zeit von 0 bedeutet nie schlieﬂen) SF-Request Nr: [1340678] [1518330]
 ...
 * - Bugfix: Standardtelefonnummern kˆnnen wieder geändert werden
 * - Bugfix: Problem mit dem Holen der Anrufliste behoben
 * - Bugfix: Nebenstellenbezeichnungen und Route kˆnnen jetzt Sonderzeichen enthalten
 ...
 * - Neu: Default-Button bei Rückfrage 'Box-Anruferliste lˆschen' geändert auf 'Nein'  
 ...
 * 								<- komplett geändert, Sprachfiles werden jetzt dynamisch erkannt und kˆnnen in den Einstellungen ausgewählt werden. (Bastian))
 ...
 * - Bugfix: Beim ƒndern des Look And Feel's werden die Buttons korrekt dargestellt.
 ...
 * - ƒnderung: Das Durchsuchen der Anruferliste muss nun per [ENTER] gestartet werden.
 * - Bugfix: "‹bernehmen" Button im Telefonbuch wird nun anklickbar, wenn man eine Telefonnummer geändert hat.
 ...
 * - Lˆschfunktionalität für Anrufliste der FRITZ!Box (Menü und Toolbar)
 ...
 * - Neuer Kommandozeilenparameter: -d, --delete_on_box, lˆscht Anrufliste auf der Box und beendet sich dann (kein GUI)
 ...
 * - Unterst¸tzung für Firmware xx.04.03
 * 
 * JFritz 0.5.3
 ...
 * - Einstelloption für "minimieren statt schlieﬂen"
 * 
 * JFritz 0.4.7
 ...
 * - Bugfix: Manche Spalten lieﬂen sich nicht klein genug machen
 ...
 * - Kommentar- und Anschluﬂ-Spalte kˆnnen ausgeblendet werden
 ...
 * - Bugfix: Falsche SIP-ID bei gelˆschten Einträgen
 * - Bugfix: Wenn Kurzwahl unbekannt war, wurde eine falsche Rufnummer angezeigt
 * - Bugfix: Anrufliste wird nur gelˆscht, wenn mind. 1 Eintrag abgeholt wurde
 * 
 * Internal: 
 ...
 * - Display more information in status barm Zielfon hˆr ich "Ihre Nummerwird gehalten...". Bitte Einbauen!! Das ist der Hammer!
...
public final class JFritz {
    ...
    private void replaceOldProperties() {
        ...
        if (properties.containsKey("column.Anschluﬂ.width")) { //$NON-NLS-1$
            properties.setProperty("column.port.width", //$NON-NLS-1$
                    properties.getProperty("column.Anschluﬂ.width")); //$NON-NLS-1$
            JFritz.removeProperty("column.Anschluﬂ.width"); //$NON-NLS-1$
        }
